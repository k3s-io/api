...
type fakeAddons struct {
	*gentype.FakeClientWithListAndApply[*v1.Addon, *v1.AddonList, *k3scattleiov1.AddonApplyConfiguration]
	Fake *FakeK3sV1
}

func newFakeAddons(fake *FakeK3sV1, namespace string) typedk3scattleiov1.AddonInterface {
	return &fakeAddons{
		gentype.NewFakeClientWithListAndApply[*v1.Addon, *v1.AddonList, *k3scattleiov1.AddonApplyConfiguration](
			fake.Fake,
			namespace,
