...
type fakeETCDSnapshotFiles struct {
	*gentype.FakeClientWithListAndApply[*v1.ETCDSnapshotFile, *v1.ETCDSnapshotFileList, *k3scattleiov1.ETCDSnapshotFileApplyConfiguration]
	Fake *FakeK3sV1
}

func newFakeETCDSnapshotFiles(fake *FakeK3sV1) typedk3scattleiov1.ETCDSnapshotFileInterface {
	return &fakeETCDSnapshotFiles{
		gentype.NewFakeClientWithListAndApply[*v1.ETCDSnapshotFile, *v1.ETCDSnapshotFileList, *k3scattleiov1.ETCDSnapshotFileApplyConfiguration](
			fake.Fake,
			"",
